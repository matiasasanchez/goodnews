...
const btnNavSimpleTrue = document.querySelector('#btnNavSimpleTrue');
const btnNavNewBorn = document.querySelector('#btnNavNewBorn');
const btnNavNoFear = document.querySelector('#btnNavNoFear');
...
const btnFooterNewBorn = document.querySelector('#btnFooterNewBorn');
const btnFooterNoFear = document.querySelector('#btnFooterNoFear');
const btnFooterTodosProductos = document.querySelector('#btnFooterTodosProductos');
const btnFooterSimpleTrue = document.querySelector('#btnFooterSimpleTrue');
...
btnNavSimpleTrue.addEventListener('click',(e)=>{
        e.preventDefault();
        let filter = filterProducts('Simple True');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
                btn__nav.classList.toggle('active');
        }
        productsInformationTitle.textContent=`Categoria: Simple True`;
...
btnNavNewBorn.addEventListener('click', (e) => {
        e.preventDefault();
        let filter = filterProducts('New Born');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
                btn__nav.classList.toggle('active');
        }
        productsInformationTitle.textContent=`Categoria: New Born`;
        productsInformationResults.textContent=`${ filter.length} Resultados`
        scrollTo(0,productsInformation.offsetTop - 50);
        setTimeout(() => {
                loadContainerProducts(filter);
...
btnNavNoFear.addEventListener('click', (e) => {
        e.preventDefault();
        let filter = filterProducts('No Fear');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
                btn__nav.classList.toggle('active');
        }
        productsInformationTitle.textContent=`Categoria: No Fear`;
        productsInformationResults.textContent=`${ filter.length} Resultados`
        scrollTo(0,productsInformation.offsetTop - 50);
        setTimeout(() => {
                loadContainerProducts(filter);
...
btnFooterSimpleTrue.addEventListener("click",(e)=>{
        e.preventDefault();
        let filter = filterProducts('Simple True');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
...
btnFooterNewBorn.addEventListener('click', (e)=>{
        e.preventDefault();
        let filter = filterProducts('New Born');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
...
btnFooterNoFear.addEventListener('click', (e) => {
        e.preventDefault();
        let filter = filterProducts('No Fear');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
